...
export default function Form() {
    ...
    return (
        <div className=' w-11/12 max-w-[550px] px-10 py-20 rounded-3xl bg-white border-2 border-gray-100'>
            ...
            <div className='mt-8'>
                ...
                <div className='flex items-center justify-between mt-8'>
                    <div>
                        ...
                        <label className='ml-2 text-base font-medium' for="remember">Remember for 30 days</label>
                    </div>
                    <button className='text-base font-medium text-violet-500'>Forgot password</button>
                </div>
                <div className='flex flex-col mt-8 gap-y-4'>
                    <button onClick={handleSignUp} className='active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-4 bg-violet-500 rounded-xl text-white font-bold text-lg'>Sign in</button>
                    <button 
                ...
                <div className='flex items-center justify-center mt-8'>
                    ...
                    <button 
                        ...
                        className='ml-2 text-base font-medium text-violet-500'>Sign up</button>
                </div>
            </div>
        </div>
    )
